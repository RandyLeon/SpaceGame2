...
namespace TheSolTrader
{
    class Trading
    {
        ...
        public void Run()
        {
            ...
            Endings.ClosingMessage(quitReason);
        }

        private Quit EventLoop()
        {
            Quit quitReason;
        ...
        {
            Quit AgeCheck() => Trader.age >= 70 ? Quit.Age : Quit.DontQuit;
            Quit MoneyCheck() => Trader.money < 0 ? Quit.OutOfMoney : Quit.DontQuit;
         ...
         'oooooooooooooooooooooooooooooooooooooooooooooooooooooo$
          '$$$$'$$$$' $$$$$$$'$$$$$$ ' '$$$$$'$$$$$$'  $$$""$$$$
           ...
           $ $ $ $ $ $ $ $ $ $ $ $ $ $ $ $ $ $ $ $ $ $ $ $ $ $ $
                                                                    ...
                                                                    ");
                Console.ResetColor();
                var itemIndex = Selection.UsersInput("What do ya have furr me: ", 1, Trader.inventory.Count);
            ...
            else
            {
                ...
                Selection.UserInput("Press any key to continue...");
            }
        }
  ...
  \ \__|<_____>____/|__
   \____<_____>_______/
    ...
    |___________|/
                                ...
                                ");
            Console.ResetColor();
            var itemIndex = Selection.UsersInput("What are yurr looking to buy: ", 1, items.Count);
